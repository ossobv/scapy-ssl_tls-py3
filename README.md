> [!WARNING]
> You probably do not need this project. scapy already has the TLS tools.
> See conversion steps like [ossobv/vcutil/tls-sniff-ciphers@9e8beb9](https://github.com/ossobv/vcutil/commit/9e8beb9b4e1725ff4bac82e55264e0824d09626c).
...
##### Option 1: pip - download latest release from the python package index
	...
	pip3 install scapy-ssl_tls-py3
...
2) locate *< scapy >* installation directory: `python3 -c "import scapy; print(scapy.__file__)"`
